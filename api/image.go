...
func (imageApi *ImageApi) ImageUpload(c *gin.Context) {
	...
	url, err := service.ServiceGroupApp.ImageService.ImageUpload(header)
	if err != nil {
...
func (imageApi *ImageApi) ImageDelete(c *gin.Context) {
	...
	err = service.ServiceGroupApp.ImageService.ImageDelete(req)
	if err != nil {
...
func (imageApi *ImageApi) ImageList(c *gin.Context) {
	...
	imageList, total, err := service.ServiceGroupApp.ImageService.ImageList(pageInfo)
	if err != nil {
