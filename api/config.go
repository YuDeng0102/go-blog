...
func (configApi *ConfigApi) UpdateWebsite(c *gin.Context) {
	...
	err = service.ServiceGroupApp.ConfigService.UpdateWebsite(req)
	if err != nil {
...
func (configApi *ConfigApi) UpdateSystem(c *gin.Context) {
	...
	err = service.ServiceGroupApp.ConfigService.UpdateSystem(req)
	if err != nil {
...
func (configApi *ConfigApi) UpdateEmail(c *gin.Context) {
	...
	err = service.ServiceGroupApp.ConfigService.UpdateEmail(req)
	if err != nil {
...
func (configApi *ConfigApi) UpdateQQ(c *gin.Context) {
	...
	err = service.ServiceGroupApp.ConfigService.UpdateQQ(req)
	if err != nil {
...
func (configApi *ConfigApi) UpdateQiniu(c *gin.Context) {
	...
	err = service.ServiceGroupApp.ConfigService.UpdateQiniu(req)
	if err != nil {
...
func (configApi *ConfigApi) UpdateJwt(c *gin.Context) {
	...
	err = service.ServiceGroupApp.ConfigService.UpdateJwt(req)
	if err != nil {
...
func (configApi *ConfigApi) UpdateGaode(c *gin.Context) {
	...
	err = service.ServiceGroupApp.ConfigService.UpdateGaode(req)
	if err != nil {
