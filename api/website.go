...
func (website *WebsiteApi) WebsiteCarousel(c *gin.Context) {
	urls := service.ServiceGroupApp.WebsiteService.WebsiteCarousel()
...
func (website *WebsiteApi) WebsiteNews(c *gin.Context) {
	...
	hotSearchData, err := service.ServiceGroupApp.WebsiteService.WebsiteNews(sourceStr)
	if err != nil {
...
func (website *WebsiteApi) WebsiteCalendar(c *gin.Context) {
	...
	calendar, err := service.ServiceGroupApp.WebsiteService.WebsiteCalendar(dateStr)
	if err != nil {
...
func (website *WebsiteApi) WebsiteFooterLink(c *gin.Context) {
	footerLinks := service.ServiceGroupApp.WebsiteService.WebsiteFooterLink()
...
func (website *WebsiteApi) WebsiteAddCarousel(c *gin.Context) {
	...
	err = service.ServiceGroupApp.WebsiteService.WebsiteAddCarousel(req)
...
func (website *WebsiteApi) WebsiteCancelCarousel(c *gin.Context) {
	...
	err = service.ServiceGroupApp.WebsiteService.WebsiteCancelCarousel(req)
...
func (website *WebsiteApi) WebsiteCreateFooterLink(c *gin.Context) {
	...
	err = service.ServiceGroupApp.WebsiteService.WebsiteCreateFooterLink(req)
...
func (website *WebsiteApi) WebsiteDeleteFooterLink(c *gin.Context) {
	...
	err = service.ServiceGroupApp.WebsiteService.WebsiteDeleteFooterLink(req)
